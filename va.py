...
#give some text input
a = gTTS("Good Morning everyone")
#print(a)
#print(type(a))
a.save("sample.mp3")'''
...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'lehimsha':'shaiklehimsha@gmail.com','sweety':'lehimsha18@gmail.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('shaiklehimsha@gmail.com','myuydiuqqamkaazr') #enter mailid and app password make sure you enable less secure app access
        mail.sendmail('shaiklehimsha@gmail.com',toaddr,content) #enter your gmail username
        mail.close()
        respond('Email Sent')
